# Fonction pour abtenir les écarts au pourcentage moyen (dans une situation où l'hypothèse d'indépendance est rejetée)
EPM <- function(x){
...
# Fonction pour abtenir les écarts à l'indépendance (dans une situation où l'hypothèse d'indépendance est rejetée)
TabEcart <- function(x){
  x <- as.matrix(x)
